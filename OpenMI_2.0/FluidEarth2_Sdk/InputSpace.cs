...
{
    public class InputSpace : BaseInputSpace, IHasValueSetConvertor, IPersistence
    {
        ...
        public InputSpace(XElement xElement, IDocumentAccessor accessor)
        {
        ...
        protected override IBaseValueSet GetValuesImplementation()
        {
            ...
            {
                SendItemChangedEvent("InputSpace({0}).Values.get, using explicit override");
        ...
        public const string XName = "InputSpace";
