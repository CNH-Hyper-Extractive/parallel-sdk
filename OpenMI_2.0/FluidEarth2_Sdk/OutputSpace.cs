...
{
    public class OutputSpace : BaseOutputSpace, IHasValueSetConvertor, IPersistence
    {
        ...
        public OutputSpace(IValueDefinition valueDefinition, ISpatialDefinition spatialDefinition, IBaseLinkableComponent component, IValueSetConverter valueSetConverter)
        ...
        public OutputSpace(XElement xElement, IDocumentAccessor accessor)
        {
        ...
        public const string XName = "OutputSpace";
